...
func _ready():
	...
	graph_manager.add_component(GraphManager.NodeType.GENERATOR, 100, 100)
	graph_manager.add_component(GraphManager.NodeType.GENERIC, 200, 200)
	var junction = graph_manager.add_component(GraphManager.NodeType.JUNCTION, 300, 300)
	junction.input_edge_list = [1, 3]
	graph_manager.add_component(GraphManager.NodeType.GENERIC, 400, 200)
	graph_manager.add_component(GraphManager.NodeType.GENERATOR, 500, 100)
